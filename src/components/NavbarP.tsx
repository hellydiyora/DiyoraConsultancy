...
const NavbarP = ({ isScrolled }: NavbarProps) => {
    ...
    >
      <div className="container mx-auto px-4 flex justify-between items-center">
        <NavLink to="/" className="flex items-center" onClick={closeMenu}>
          <Briefcase 
            className={`mr-2 transition-colors ${isScrolled ? 'text-primary' : 'text-primary-dark'}`} 
            size={28} 
          />
          <span 
                ...
                <NavLink
                  ...
                  className={({ isActive }) => `
                    ...
                    ${isScrolled 
                      ...
                      : (isActive ? 'text-primary-dark font-semibold' : 'text-primary')}
                  `}
                >
                  {item}
                </NavLink>
        ...
        >
          {isOpen ? (
            <X className={isScrolled ? 'text-primary' : 'text-primary-dark'} size={24} />
          ) : (
            <Menu className={isScrolled ? 'text-primary' : 'text-primary-dark'} size={24} />
          )}
        </button>
      </div>
